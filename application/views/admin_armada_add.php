	 ...
	 <!-- Section: Main chart -->
		  <section class="mb-4">
			<div class="card">
			  ...
			  <div class="card-body">
				<form action="<?=site_url('/admin/armada_add_go')?>" method="post">
					<div class="form-group mb-2">
					  <label for="nama">Nama Armada:</label>
					  <input name="nama_armada" type="text" class="form-control" id="nama" placeholder="Masukkan nama....">
					</div>
					<div class="form-group mb-2">
					  <label for="nama">Tipe Armada:</label>
					  <input name="tipe_mobil" type="text" class="form-control" id="nama" placeholder="Masukkan alamat....">
					</div>
					<div class="form-group mb-2">
					  <label for="nama">Jumlah Tampungan:</label>
					  <input name="jumlah_tampungan" type="numer" class="form-control" id="nama" placeholder="Masukkan nomor telpon....">
					</div>
