		  ...
		  <section class="mb-4">
			<div class="card">
			  <div class="card-header py-3">
				<h5 class="mb-0"><strong>Edit Tujuan</strong></h5>
			  </div>
			  <div class="card-body">
				<form action="<?=site_url('/admin/tujuan_edit_go')?>" method="post">
					<div class="form-group mb-2">
					  <input name="id_tujuan" type="hidden" class="form-control" id="nama" value="<?=$obj_tujuan->id_tujuan?>">
					</div>
					<div class="form-group mb-2">
					  <label for="nama">Nama Tujuan:</label>
					  <input name="nama_tujuan" type="text" class="form-control" id="nama" value="<?=$obj_tujuan->nama_tujuan?>">
					</div>
					<div class="form-group mb-2">
					  <label for="nama">Keterangan:</label>
					  <input name="paket" type="text" class="form-control" id="nama" value="<?=$obj_tujuan->paket?>">
					</div>
					<div class="form-group mb-2">
					  <label for="nama">Harga:</label>
					  <input name="harga" type="numer" class="form-control" id="nama" value="<?=$obj_tujuan->harga?>">
					</div>
