		  ...
		  <section class="mb-4">
			<div class="card">
			  <div class="card-header py-3">
				<h5 class="mb-0"><strong>Ubah Pelanggan</strong></h5>
			  </div>
			  <div class="card-body">
				<form action="<?=site_url('/admin/pelanggan_edit_go')?>" method="post">
					<div class="form-group mb-2">
					  <input name="id_pelanggan" type="text" class="form-control" id="nama" value="<?=$obj_pelanggan->id_pelanggan?>">
					</div>
					<div class="form-group mb-2">
					...
					<div class="form-group mb-2">
					  ...
					  <input name="no_telpon" type="numer" class="form-control" id="nama" value="<?=$obj_pelanggan->no_telpon?>">
					</div>
