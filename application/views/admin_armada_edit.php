		  ...
		  <section class="mb-4">
			<div class="card">
			  <div class="card-header py-3">
				<h5 class="mb-0"><strong>Tambah Armada</strong></h5>
			  </div>
			  <div class="card-body">
				<form action="<?=site_url('/admin/armada_edit_go')?>" method="post">
					<div class="form-group mb-2">
					  <input name="id_armada" type="hidden" class="form-control" value="<?= $obj_armada->id_armada ?>">
					</div>
					<div class="form-group mb-2">
					  <label for="nama">Nama Armada:</label>
					  <input name="nama_armada" type="text" class="form-control" id="nama" value="<?= $obj_armada->nama_armada ?>">
					</div>
					<div class="form-group mb-2">
					  <label for="nama">Tipe Armada:</label>
					  <input name="tipe_mobil" type="text" class="form-control" id="nama" value="<?= $obj_armada->tipe_mobil ?>">
					</div>
					<div class="form-group mb-2">
					  <label for="nama">Jumlah Tampungan:</label>
					  <input name="jumlah_tampungan" type="numer" class="form-control" id="nama" value="<?= $obj_armada->jumlah_tampungan ?>">
					</div>
